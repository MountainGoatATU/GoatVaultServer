...
from app.routes import token_route, user_route, vault_route
...
app.include_router(vault_route.vault_router, prefix="/v1")
app.include_router(token_route.token_router, prefix="/v1")
